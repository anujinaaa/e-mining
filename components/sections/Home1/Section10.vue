        ...
        <div class="rounded-2xl p-[30px] md:py-[53px] md:px-[48px] gap-5 mx-auto bg-orange-100 md:flex lg:gap-[40px] lg:h-[420px] xl:h-[390px] max-w-[1190px]" padding="px-[15px] py-[50px] md:px-[52px] md:py-[72px]">
            <div class="flex-1 mb-[30px]">
                <p class="text-capitalized uppercase text-gray-500 tracking-[2px] mb-[13px]">
                  мэдээллийн товхимол</p>
                <h4 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[20px]">
                  Манай мэдээллийн товхимолд бүртгүүлээрэй</h4>
                <p class="text-text text-gray-500">Товчлуур дээр дарснаар та бидэнтэй санал нийлж байна</p>
                <NuxtLink class="text-green-900" to="/index">Нөхцөл ба нөхцөл</NuxtLink>
